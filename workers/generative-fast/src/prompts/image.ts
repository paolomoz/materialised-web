...
Brand elements: Modern Vitamix blender visible when appropriate
`;
...
const CONTENT_TYPE_PROMPTS: Record<string, string> = {
  recipe: `
    ...
    Fresh ingredients artfully arranged
    Natural daylight streaming through window
    Vitamix blender in soft focus background
  ...
  `,
  smoothie: `
    Colorful smoothie in clear glass
    Fresh ingredients scattered nearby
    Droplets of condensation for freshness
    Vibrant colors (greens, berries, tropical)
    Vitamix blender partially visible
  `,
  soup: `
